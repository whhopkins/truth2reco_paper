...
After the NN has been trained to learn the PDF of \ptRes, the resulting learned PDF is compared to the Delphes PDF using the testing sample in Figure~\ref{fig:PDFComp}a. Good agreement is observed between the Delphes and NN PDFs, showing that the NN has learned the bulk distribution.
...
To test whether the NN learned the jet resolution for a large range of \pt s, the mean and standard deviation of the resolution (shown, inclusively, in Figurre~\ref{fig:PDFComp}) was plotted as a function of \pt\ in Figure~\ref{fig:resVsPt}. The mean of the resolution for the NN is systematically higher than the resolution for Delphes but this effect is small when considering the width of the resolution. The standard deviation of the resolution, however, are the same for the NN and Delphes across the \pt\ range. 
